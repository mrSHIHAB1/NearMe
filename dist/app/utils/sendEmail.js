...
const smtpPort = Number(env_1.envVars.EMAIL_SENDER.SMTP_PORT);
...
const sendEmail = (_a) => __awaiter(void 0, [_a], void 0, function* ({ to, subject, templateName, templateData, attachments }) {
    ...
    try {
        ...
        console.log("email sending error", (_b = error === null || error === void 0 ? void 0 : error.message) !== null && _b !== void 0 ? _b : error);
        // In development, don't crash the app just because SMTP isn't configured.
        if (env_1.envVars.NODE_ENV !== "production") {
            return;
        }
        throw new AppError_1.default(500, "Email error");
    }
});
